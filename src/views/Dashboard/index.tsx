...
import { TotalCab, TotalCompany, TotalDriver, TotalEmployee } from 'constants/api';
                        ...
                        <Row gutter={16}>
                            <Col span={6} md={6} sm={12} xs={24}>
                                <Card >
                                    <CardBox>
                                        <Counter>
                                            <TotalNumber>{totalComapny}</TotalNumber>
                                            <TextField>Total No Of Company</TextField>
                                        </Counter>
                                        <UserOutlined />
                                    </CardBox>
                                    <TextParagraph > <Link to="/Company/company-list" >more info <ArrowRightOutlined /></Link></TextParagraph>
                                </Card>
                            </Col>
                                ...
                                <Card >
                                    <CardBox>
                                        <Counter>
                                            ...
                                            <TextField>Total No Of subscriber</TextField>
                                        </Counter>
                                        <UserOutlined />
                                    </CardBox>
